...
<html>
<head>
    <title>Calculadora de taxas de câmbio de moedas do Laravel</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            Calculadora de taxas de câmbio de moedas do Laravel
        </div>
        <div class="card-body">
            <form id="currency-exchange-rate" action="#" method="post" class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input type="submit" name="submit" id="btnSubmit" class="btn btn-primary " value="Clique para taxa de câmbio">
                    </div>
                </div>
            </form>
        </div>
